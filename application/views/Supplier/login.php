...
<body>
	<div class="login-wrap customscroll d-flex align-items-center flex-wrap justify-content-center pd-20">
		<div class="login-box bg-white box-shadow pd-30 border-radius-5">
			...
			<h2 class="text-center mb-30">Login Supplier</h2>
			...
			<?php } ?>
			<form action="<?= base_url('auth/supplier') ?>" method="POST">
				<div class="input-group custom input-group-lg">
					<input type="text" name="username_supplier" class="form-control" placeholder="Username">
					<div class="input-group-append custom">
						<span class="input-group-text"><i class="fa fa-user" aria-hidden="true"></i></span>
					</div>
					<?= form_error('username supplier', '<small class="text-danger">', '</small>') ?>
				</div>
				<div class="input-group custom input-group-lg">
					<input type="password" class="form-control" name="password_supplier" placeholder="**********">
					<div class="input-group-append custom">
						<span class="input-group-text"><i class="fa fa-lock" aria-hidden="true"></i></span>
					</div>
					<?= form_error('password supplier', '<small class="text-danger">', '</small>') ?>
				</div>
				<div class="row">
					<div class="col-sm-6">
